...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'chishenma_app_restaurant', (
            ...
            ('rest_latlong', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
    ...
    models = {
        ...
        u'chishenma_app.restaurant': {
            ...
            'rest_latlong': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
